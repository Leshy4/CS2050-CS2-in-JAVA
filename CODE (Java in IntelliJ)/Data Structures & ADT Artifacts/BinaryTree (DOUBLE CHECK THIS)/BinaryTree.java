/** Description: Homework 08 - BinaryTree class           * Name: Christopher Welch           */

public class BinaryTree<T extends Comparable<T>> {
    private BinNode<T> root;
    private int branchHeight =0;
    ...
    public boolean isBalanced() {
        ...
        if(leftHeight - rightHeight < 2 && rightHeight - leftHeight < 2) return true;
        return false;
    }
