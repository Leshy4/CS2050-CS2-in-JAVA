...
public class DecisionTreeDriver {
    ...
    // Reads input files and returns a list of Data Point objects
    ...
    // Implements the ID3 algorithm from a given list of data point objects and
    // another list of attribute indices returns a decision tree
    public static DecisionTree id3(LinkedList<DataPoint> dps, LinkedList<Integer> attributes) {
        ...
        DecisionTree tree = new DecisionTree(); // Creates a tree
        Iterator<DataPoint> dpsIt = dps.iterator(); // Checks if all data points have the same target value
        ...
        while (attrIt.hasNext()) {
            ...
            while (valIt.hasNext()) {
                double value = valIt.next();         // value is the current attribute value

                // tempLeft and tempRight to split the list of data point objects
